class HomeController < ApplicationController
  ...
  def index    
    ...
    if IndividualType.find_by_title('Team')
      ...
      displayed_team_members_number = [ENV["DISPLAYED_TEAM_MEMBERS"].to_i, @team_members.count].min
    ...
    if IndividualType.find_by_title('Speakers')
      ...
      displayed_speakers_number = [ENV["DISPLAYED_SPEAKERS"].to_i, @speakers.count].min
